...
function Pose2d:equals(other)
    return lib.frcPose2dEquals(self, other)
end

---Returns the underlying translation.
---@return Translation2d
function Pose2d:translation()
    return lib.frcPose2dTranslation(self)
end

---Returns the X component of the pose's translation.
---@return number
function Pose2d:x()
    return lib.frcPose2dX(self)
end

---Returns the Y component of the pose's translation.
---@return number
function Pose2d:y()
    return lib.frcPose2dY(self)
end

---Returns the underlying rotation.
---@return Rotation2d
function Pose2d:rotation()
    return lib.frcPose2dRotation(self)
end
...
function Pose2d:rotateBy(rotation)
    return lib.frcPose2dRotateBy(self, rotation)
end
...
function Pose2d:transformBy(transform)
    return lib.frcPose2dTransformBy(self, transform)
end
...
function Pose2d:relativeTo(other)
    return lib.frcPose2dRelativeTo(self, other)
end
...
function Pose2d:exp(twist)
    return lib.frcPose2dExp(self, twist)
end
...
function Pose2d:log(other)
    return lib.frcPose2dLog(self, other)
end
...
setmetatable(Pose2d, {
    __call = function(_, ...)
        ...
        if nargs >= 2 then
            ...
            impl = ffi.gc(lib.frcPose2dNew(x or 0, y or 0, z or 0), lib.frcPose2dFree)
        else
            impl = ffi.gc(lib.frcPose2dNew(0, 0, 0), lib.frcPose2dFree)
        end
