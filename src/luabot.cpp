...
static int pmain (lua_State* L) {
    ...
    // FIXME: luaL_checkversion (L);           /* check that interpreter has correct version */
...
static lua_State* globalL   = NULL;
static const char* progname = "luabot";
...
static void print_version (void) {
    fputs ("LuaBot 0.0.0 -- Copyright (C) 2024 The LuaBOT Developers.\n", stdout);
    fputs (LUAJIT_VERSION " -- " LUAJIT_COPYRIGHT ". " LUAJIT_URL "\n", stdout);
}
